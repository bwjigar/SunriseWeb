...
var columnDefs = [
    ...
    { headerName: $("#hdn_Price_Cts").val(), field: "price_per_cts", hide: jbbrothers, width: 75, cellRenderer: function (params) { return formatNumber(params.value); }, cellRenderer: function (params) { return formatNumber(params.value) } },
