...
var columnDefs = [
    ...
    //        }
    //    },
    //    cellRenderer: Ready_For_Pick_up
    //},
    //{
    //    headerName: $("#hdn_Ready_to_Pick_up").val(),
    //    field: "PickUp_Status",
    ...
    //    width: 70,
    //    sortable: false,
    //    cellRenderer: Ready_For_Pick_up1
    //},
    {
        headerName: $("#hdn_Ready_to_Pick_up").val(),
        field: "PickUp_Status",
    ...
    {
        headerName: $("#hdn_Username").val(), field: "UserName", hide: IsObj_IsPrmry, tooltip: function (params) { return (params.value); }, width: 150, filter: 'agSetColumnFilter'
        , filterParams: {
            values: [],
            resetButton: true,
            applyButton: true
    ...
    {
        headerName: $("#hdn_CustomerName").val(), field: "CustomerName", hide: IsObj_IsPrmry, tooltip: function (params) { return (params.value); }, width: 180, filter: 'agSetColumnFilter'
        , filterParams: {
            values: [],
            resetButton: true,
            applyButton: true
    ...
    { headerName: $("#hdn_Lab").val(), field: "sLab", tooltip: function (params) { return (params.value); }, width: 45, cellRenderer: LotValueGetter, sortable: false },
    {
    ...
    { headerName: $("#hdn_Final_Value").val(), field: "Net_Value", hide: jbbrothers, tooltip: function (params) { return formatNumber(params.value); }, width: 90, cellStyle: { color: 'blue', 'font-weight': 'bold', 'background-color': '#fdfdc1'}, cellRenderer: function (params) { return formatNumber(params.value); }, sortable: true },
    { headerName: $("#hdn_Final_Disc_Per").val(), field: "Final_Disc", hide: jbbrothers, tooltip: function (params) { return formatNumber(params.value); }, width: 90, cellStyle: { color: 'blue', 'font-weight': 'bold', 'background-color': '#fdfdc1' }, cellRenderer: function (params) { if (params.value != 0) { return formatNumber(params.value); } }, sortable: true },
